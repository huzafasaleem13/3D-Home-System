  ...
  return (
    <section>
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        {activeScene ? (
          <p className="border border-emerald-800/25 bg-emerald-50 px-3 py-2 text-sm font-medium text-emerald-800">
            {activeScene.name} is active
          </p>
        ) : (
          <p className="text-sm text-stone-500">No scene is currently active</p>
        )}
      </div>
          ...
          return (
            <article
              ...
              className={`border p-5 transition-all duration-300 ${
                isActive
                  ? "border-stone-700 bg-[#ebe5d9]"
                  : "border-stone-300 bg-[#f7f4ed] hover:-translate-y-0.5 hover:border-stone-400"
              }`}
            >
              ...
              <h3 className="mt-7 text-lg font-semibold tracking-tight text-stone-900">
                {scene.name}
              </h3>
              ...
              <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-stone-300 pt-4">
                ...
                <button
                  ...
                  className={`border px-3 py-2 text-sm font-semibold transition-colors duration-200 ${
                    isActive
                      ? "border-stone-700 bg-stone-800 text-stone-50 hover:bg-stone-700"
