        ...
        <div
          className={`border px-3 py-2 text-sm font-semibold ${
            isHomeArmed
              ...
              : "border-amber-800/25 bg-amber-50 text-amber-800"
          }`}
        >
      ...
      <div className="mt-7 grid gap-5 xl:grid-cols-[minmax(0,1fr)_300px]">
        <div className="space-y-5">
          <div className="border border-stone-300 bg-[#f7f4ed] p-5">
            ...
            <div
              className={`mt-5 grid min-h-72 place-items-center border border-stone-300 ${selectedCamera.color}`}
            >
              <div className="text-center">
                <span className="mx-auto block h-12 w-16 border-4 border-stone-700/70" />
              ...
              <button
                ...
                className={`min-w-20 border px-3 py-2 text-xs font-semibold transition-colors duration-200 ${
                  isFrontDoorLocked
                    ...
                    : "border-amber-800/30 bg-amber-50 text-amber-800"
                }`}
              >
